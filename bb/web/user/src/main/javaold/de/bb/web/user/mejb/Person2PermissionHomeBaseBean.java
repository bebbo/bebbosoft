...
abstract class Person2PermissionHomeBaseBean extends de.bb.mejb.CMPHomeBean implements
        de.bb.web.user.mejb.Person2PermissionHomeBase {
    ...
    Person2PermissionHomeBaseBean(javax.ejb.EJBHome home) throws java.rmi.RemoteException {
        super(home, "Person2Permission");
        if (dbi == null)
            init();
    }
    ...
    public java.util.Collection findByPerson(Object id) throws java.rmi.RemoteException {
        return this.queryCollection("SELECT * FROM Person2Permission WHERE id_Person=? ORDER BY ID",
                new Object[] { id });
    }

    public java.util.Collection findByPermission(Object id) throws java.rmi.RemoteException {
        return this.queryCollection("SELECT * FROM Person2Permission WHERE id_Permission=? ORDER BY ID",
                new Object[] { id });
    }
}
