...
public class MkSS {
        ...
        try {
            ...
            for (int i = 0; i < mts.length; ++i) {
                ...
                if (params.length > 0) {
                    ...
                    fx.c_invokevirtual("de/bb/rmi/Client", "invoke",
                            "(Ljava/lang/String;JI[Ljava/lang/Object;)Ljava/lang/Object;");
                } else {
                    fx.c_invokevirtual("de/bb/rmi/Client", "invoke", "(Ljava/lang/String;JI)Ljava/lang/Object;");
                }
    ...
    static void mkskel(String className) {
        ...
        try {
            ...
            emit("public class " + ocName + "_Skel implements de.bb.rmi.ISkeleton\r\n");
            emit("{\r\n");
