/******************************************************************************
 * $Source: /export/CVS/java/de/bb/util/src/main/java/de/bb/util/ByteRef.java,v $
 * $Revision: 1.38 $
 * $Date: 2014/09/22 09:13:03 $
 * $Author: bebbo $
 * $Locker:  $
 * $State: Exp $
 *
...
/******************************************************************************
 * $Log: ByteRef.java,v $
 * Revision 1.38  2014/09/22 09:13:03  bebbo
 * @N new convenience method to append byte arrays
 *
 * Revision 1.37  2014/06/23 19:09:35  bebbo
 * @R clone() is now typed
 *
 * Revision 1.36  2013/11/23 10:38:04  bebbo
 * @N added a toLong() method to read long values
 *
 * Revision 1.35  2013/06/18 13:25:14  bebbo
 * @R update methods are using an reasonable minimal count of data (0x2000) to read ahead
 * Revision 1.34 2013/06/07 16:27:51 bebbo
 * 
 * @N added update methods for RandomAccessFile
 * @B readLine could add an empty line, if the buffer splitted \r\n. Revision 1.33 2011/04/27 11:09:54 bebbo
 * 
 * @N added the medthog nextLineCRLF to parse lines easier. Revision 1.32 2011/01/01 11:59:01 bebbo
 * 
 * @R ByteRef is no longer final to allow derived classes Revision 1.31 2008/06/04 06:46:09 bebbo
 * 
 * @N new method to convert bytes to a String using a specified encoding. String toString (String encoding);
 * 
 *    Revision 1.30 2008/03/15 18:01:05 bebbo
 * @R Changed the license: From now on GPL 3 applies.
 * 
 *    Revision 1.29 2008/03/13 20:51:02 bebbo
 * @R made class and all methods final
 * 
 *    Revision 1.28 2006/10/04 08:15:30 bebbo
 * @I better variable names
 * 
 *    Revision 1.27 2006/05/09 08:54:24 bebbo
 * @I removed unused variables
 * 
 *    Revision 1.26 2006/03/17 11:37:37 bebbo
 * @B changed toString behaviour: high byte is now 0
 * 
 *    Revision 1.25 2006/02/02 07:51:20 bebbo
 * @I cleanup
 * 
 *    Revision 1.24 2004/04/14 13:57:51 bebbo
 * @B fixed JavaDoc issues
 * 
 *    Revision 1.23 2004/03/14 18:01:13 bebbo
 * @I implementet startsWith() and endsWith() without using substring()
 * @N added splitLeft() method which MODIFIES current object and returns left part
 * 
 *    Revision 1.22 2002/09/30 07:34:03 bebbo
 * @B update() could be very slow - changed readahead buffer size
 * 
 *    Revision 1.21 2002/05/16 15:25:29 franke
 * @I modified update()
 * 
 *    Revision 1.20 2002/01/22 09:38:18 bebbo
 * @B fixed equalsIgnoreCase()
 * 
 *    Revision 1.19 2002/01/22 09:04:04 bebbo
 * @C javadoc
 * 
 *    Revision 1.18 2002/01/19 15:47:21 franke
 * @N added equalsIgnoreCase(), clone()
 * @I added minimal read in update()
 * 
 *    Revision 1.17 2002/01/16 15:32:11 franke
 * @N added more support functions
 * 
 *    Revision 1.16 2001/12/10 11:56:07 bebbo
 * @C completed comments!
 * 
 *    Revision 1.15 2001/09/15 08:55:41 bebbo
 * @C added many comments
 * 
 *    Revision 1.14 2001/08/24 08:23:44 bebbo
 * @R renamed functions - same names as in String class
 * 
 *    Revision 1.13 2001/08/03 13:48:57 bebbo
 * @B fixed EOL doubling at buffer end
 * 
 *    Revision 1.12 2001/05/14 21:40:23 bebbo
 * @B removed an optimization which caused bugs
 * 
 *    Revision 1.11 2001/05/07 16:20:54 bebbo
 * @I improved (really?) method update(): try to reuse existing buffer
 * 
 *    Revision 1.10 2001/04/16 13:36:22 bebbo
 * @N added nextWord()
 * @N added compareTo(ByteRef)
 * @N added append(String )
 * 
 *    Revision 1.9 2001/03/28 13:28:46 bebbo
 * @B final fix in update(InputStream is)
 * 
 *    Revision 1.8 2001/03/28 10:27:21 bebbo
 * @B fixed function update() - did not wait for data properly
 * 
 *    Revision 1.7 2001/03/11 20:42:12 bebbo
 * @B fixed indexOf
 * 
 *    Revision 1.6 2001/03/09 19:50:13 bebbo
 * @B assign now performs more checks
 * 
 *    Revision 1.5 2001/02/25 17:06:17 bebbo
 * @N added static mehtod readLine
 * 
 *    Revision 1.4 2001/01/15 16:32:54 bebbo
 * @I rewrote nextLine()
 * @N added charAt()
 * 
 *    Revision 1.3 2001/01/01 16:53:06 bebbo
 * @R added CT for byte[]
 * @R added toByteArray()
 * 
 *    Revision 1.2 2000/12/29 17:47:03 bebbo
 * @N new functions
 * 
 *    Revision 1.1 2000/11/10 18:12:26 bebbo
 * @N new
 * 
 *****************************************************************************/
