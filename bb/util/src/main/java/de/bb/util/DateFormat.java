/******************************************************************************
 * $Source: /export/CVS/java/de/bb/util/src/main/java/de/bb/util/DateFormat.java,v $
 * $Revision: 1.40 $
 * $Date: 2013/08/13 17:58:28 $
 * $Author: bebbo $
 * $Locker:  $
 * $State: Exp $
 *
 ...
 * Revision 1.40  2013/08/13 17:58:28  bebbo
 * @B always use the raw offset - no support for DST
 *
 * Revision 1.39  2011/01/01 12:00:18  bebbo
 * @B fixed formatting of seconds with leading zeros
 * Revision 1.37 2009/01/27 18:54:20 bebbo
 * 
 * @B leading zeros are now ommitted so 7:07 is display instead of 07:07
 * 
 *    Revision 1.36 2008/03/15 18:01:05 bebbo
 * @R Changed the license: From now on GPL 3 applies.
 * 
 *    Revision 1.35 2008/01/17 17:38:29 bebbo
 * @O enhanced output for 8 bit char set
 * 
 *    Revision 1.34 2007/01/18 22:02:04 bebbo
 * @C naming cleanup
 * 
 *    Revision 1.33 2006/02/02 07:52:29 bebbo
 * @I cleanup
 * 
 *    Revision 1.32 2005/02/15 14:29:55 bebbo
 * @B fixed getWeekDay
 * 
 *    Revision 1.31 2005/02/13 17:19:59 bebbo
 * @B added timezone usage to getXX methods
 * 
 *    Revision 1.30 2005/02/13 15:17:36 bebbo
 * @N added a parse method to DateFormat objects.
 * @N added some convenient methods to retrieve information from date values
 * 
 *    Revision 1.29 2004/12/08 14:44:38 bebbo
 * @B fixed week calculations
 * 
 *    Revision 1.28 2004/12/08 12:54:20 bebbo
 * @B fixed date calculation and verified it for 31.12 01.01 of all years
 * 
 *    Revision 1.27 2004/11/18 14:54:32 bebbo
 * @B fixed timezone formatting
 * 
 *    Revision 1.26 2004/03/24 09:34:44 bebbo
 * @I redesigned parse methods
 * @B GMT resets time zone to 0 so GMT is now really the same as GMT +0
 * 
 *    Revision 1.25 2004/01/01 16:07:39 bebbo
 * @B fixed fast dateformat
 * 
 *    Revision 1.24 2003/06/04 12:17:36 bebbo
 * @R parse_... function are using default time zone if ommitted
 * 
 *    Revision 1.23 2003/04/02 12:15:36 bebbo
 * @C resolved API Doc errors
 * 
 *    Revision 1.22 2003/02/25 15:16:56 bebbo
 * @B getWeek() and other functions are based on GMT now
 * 
 *    Revision 1.21 2003/02/09 22:09:22 bebbo
 * @N new methods
 * 
 *    Revision 1.20 2003/01/09 22:57:20 bebbo
 * @N new function to determine first day of a week
 * 
 *    Revision 1.19 2003/01/06 09:31:18 bebbo
 * @B fixed timzone: used ms as seconds...
 * 
 *    Revision 1.18 2003/01/03 18:19:19 bebbo
 * @R intermediate version
 * 
 *    Revision 1.17 2002/12/20 12:08:30 bebbo
 * @I experimental new TZ detection (thanks to Matz)
 * 
 *    Revision 1.16 2002/11/18 11:42:11 bebbo
 * @N new function yyyyMMddHHmmssSSS(long millis)
 * 
 *    Revision 1.15 2002/11/18 11:23:02 bebbo
 * @N ct for user defined format functions exist now
 * 
 *    Revision 1.14 2002/11/06 09:46:47 bebbo
 * @I cleanup for imports
 * 
 *    Revision 1.13 2002/05/21 15:39:54 bebbo
 * @C formatted
 * 
 *    Revision 1.12 2002/04/02 13:03:24 franke
 * @N new function, to printas GMTtime
 * 
 *    Revision 1.11 2002/01/20 12:00:44 franke
 * @B more tolerant handling with erraneous time zones
 * 
 *    Revision 1.10 2002/01/16 09:54:37 franke
 * @C fixed comments
 * 
 *    Revision 1.9 2001/12/10 16:22:50 bebbo
 * @C completed comments!
 * 
 *    Revision 1.8 2001/10/08 18:24:22 bebbo
 * @N added function eastern() to determine eastern for every year
 * 
 *    Revision 1.7 2001/09/15 08:55:51 bebbo
 * @C added comments
 * 
 *    Revision 1.6 2001/05/06 13:11:39 bebbo
 * @R date format function changed name
 * @R removed colon in GMT
 * 
 *    Revision 1.5 2001/04/22 21:40:12 bebbo
 * @N added correct format function for http log
 * 
 *    Revision 1.4 2001/04/22 20:27:15 bebbo
 * @I now parsing environment for TZ=... and override the timezone
 * 
 *    Revision 1.3 2001/03/27 19:45:27 bebbo
 * @R removed / in Dateformat
 * 
