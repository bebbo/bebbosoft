...
*/
   ...
   * @param m
   */
  private static void addYingMethod(String className, ClassDefinition cd,
      Method m, int fxNo)
  {
    ...
    if (params.length > 0) {
      ...
      for (int j = 0; j < params.length; ++j) {
        ...
        if (param.isPrimitive()) {
          ...
          fx.c_invokespecial(pName, "<init>", "(" + type2Raw(param.getName())
              + ")V");
    ...
    cd.defineMethod(0x0001, mName, "(" + fxParam + ")" + rawName, fx,
...
*/
    ...
    fx
        .c_invokespecial("java/lang/Exception", "<init>",
            "(Ljava/lang/String;)V");
    fx.c_athrow();

    cd.defineMethod(0x0001, "invoke",
        "(Ljava/lang/Object;I[Ljava/lang/Object;)Ljava/lang/Object;", fx,
   ...
   * @param clazz
   */
  private static void collectRemoteMethods(HashMap hm, Class clazz)
  {
    Class[] ifaces = clazz.getInterfaces();
    for (int i = 0; i < ifaces.length; ++i)
    {
   ...
   * @param fxNo
   */
  private static void addYangMethod(String ocBaseName, ClassDefinition cd,
      ArrayList cases, Method m, int fxNo)
  {
  ...
  private static String cvtType(String pName)
  {
    ...
    return "java.lang." + pName.substring(0, 1).toUpperCase()
        + pName.substring(1);
  }
