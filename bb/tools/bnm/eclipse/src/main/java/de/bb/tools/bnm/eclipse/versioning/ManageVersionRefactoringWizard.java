...
public class ManageVersionRefactoringWizard extends VersionRefactoringWizard {

	public ManageVersionRefactoringWizard(ManageVersionRefactoring refactoring,
			int flags) throws CoreException, IOException {
		super(refactoring, flags);
		setWindowTitle("Manage Versions");
	}

	
	protected IWizardPage createSelectVersionPage() {
		return new ManageVersionPage(versionRefactoring.getData());
	}
