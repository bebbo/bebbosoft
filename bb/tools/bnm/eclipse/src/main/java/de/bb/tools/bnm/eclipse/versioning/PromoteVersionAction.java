...
public class PromoteVersionAction extends PomAction {
    public PromoteVersionAction() {
        super(true, true);
    }
    ...
    public void run(IAction action) {
        ...
        try {
            VersionRefactoring r = new PromoteVersionRefactoring(currentProject);

            VersionRefactoringWizard w = new PromoteVersionRefactoringWizard(r, 2);
