...
public class ReleaseVersionRefactoringWizard extends RefactoringWizard {

  
  public ReleaseVersionRefactoringWizard(ReleaseVersionRefactoring refactoring,
      int flags) throws CoreException, IOException {
    super(refactoring, flags);
    setWindowTitle("Release Versions");
  }
