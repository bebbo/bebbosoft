...
public class BnmNature implements IProjectNature {

	/**
	 * ID of this project nature
	 */
	public static final String NATURE_ID = "de.bb.tools.bnm.eclipse.bnmNature";
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(BnmBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(BnmBuilder.BUILDER_ID);
