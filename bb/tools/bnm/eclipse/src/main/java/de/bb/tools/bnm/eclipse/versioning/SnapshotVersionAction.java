...
public class SnapshotVersionAction extends PomAction {

    public SnapshotVersionAction() {
        super(true, true);
    }
    ...
    public void run(IAction action) {
        ...
        try {
            ...
            SnapshotVersionRefactoring r = new SnapshotVersionRefactoring(currentFile);

            SnapshotVersionRefactoringWizard w = new SnapshotVersionRefactoringWizard(r, 2);
