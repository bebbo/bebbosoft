 ...
 *   
 *   (c) by Stefan "Bebbo" Franke 2009-2011-2011
 */
...
public class PromoteVersionRefactoringWizard extends VersionRefactoringWizard {

	public PromoteVersionRefactoringWizard(VersionRefactoring refactoring,
			int flags) throws CoreException, IOException {
		super(refactoring, flags);

		setWindowTitle("Version Refactoring");
	}

	
	protected IWizardPage createSelectVersionPage() {
		return new PromoteVersionPage(versionRefactoring.getData());
	}
