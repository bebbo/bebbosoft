...
public class PromoteVersionPage extends VersionPage {

  protected PromoteVersionPage(VI[] data) {
    super(data, "Version Promotion", "Promote versions to SNAPSHOT or modify existing SNAPSHOT versions.");
  }  
}
