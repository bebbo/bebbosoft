...
//        System.out.println(axml.toString());
    ...
    private void addArtifact(XmlFile axml, Id id, boolean isFeature) throws Exception {
        ...
        final File outFile = new File(isFeature ? featureDir : pluginsDir, id.groupId + "." + id.artifactId + "-"
                + id.version + ".jar");
    ...
    private String addRequired(XmlFile xml, String key, String name, String version) {
        ...
        xml.setString(r, "range", "[" + version + "," + version + "]");
        return r;
    }
