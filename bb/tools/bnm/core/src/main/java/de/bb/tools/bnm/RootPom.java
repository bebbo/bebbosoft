...
/**
 * root pom - provides the environment.
 * 
 * @author sfranke
 * 
 */
public class RootPom extends Pom {

    public RootPom(Bnm bnm, Project project) throws Exception {
        super(bnm, project);
        addProperties("env", (Map<String, String>)(Object) System.getProperties());
    }
