...
public class IOUtils {
	...
	/**
	 * Copy the given length of data from the given <code>InputStream</code> to the
	...
	/**
	 * Read the given length of data from the given <code>InputStream</code> to the
	 * given <code>byte []</code> buffer.
	 * 
	 * @param is
	 *            the <code>InputStream</code>
	 * @param buffer
	 ...
	 *             on error, e.g. if the given length of data was not reached.
	 */
	public static void readFully(InputStream is, byte[] buffer, int position, int length)
			throws IOException {
	...
	/**
	 * Read a complete file into byte array.
	 * 
	 * @param file
	 *            the file
