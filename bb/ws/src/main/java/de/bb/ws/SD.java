...
public class SD extends ServiceDelegate {
    ...
    SD(URL wsdlDocumentLocation, Class<? extends javax.xml.ws.Service> serviceClass) {
    ...
    private static XmlFile loadXmlFile(URL wsdlDocumentLocation) {
        try {
            ...
            throw new javax.xml.ws.WebServiceException(e);
        }
    }
    ...
    public <T> T getPort(QName portName, Class<T> serviceEndpointInterface) {
        ...
        T proxy = (T) Proxy.newProxyInstance(serviceEndpointInterface.getClassLoader(), new Class[] {
                serviceEndpointInterface, BindingProvider.class }, h);
